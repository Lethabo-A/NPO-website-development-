<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewStaff.aspx.cs" Inherits="CMPG223_project.AddNewStaff" %>
...
<body>
    <form id="form1" runat="server" class="auto-style1">
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" CssClass="auto-style2">Logout</asp:HyperLink>
        <p>
