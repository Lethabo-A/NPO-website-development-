<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_Expense_FormAnd_Income.aspx.cs" Inherits="CMPG223_project.Add_Expense_Form" %>
...
<head runat="server">
    <title></title>
    <link href="AddExpenseCSS" rel="stylesheet" type="text/css" />
    <style type="text/css">
        .auto-style1 {
            font-size: xx-large;
        }
