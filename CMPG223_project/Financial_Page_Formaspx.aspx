...
<body>
    ...
    <div class="header">
        <img src="images/NGOs.png" alt="logo" class="auto-style3" />&nbsp;<h1>Financial Page</h1>
    </div>
    ...
    <form id="form1" runat="server">
        ...
        <div>
             <asp:DropDownList ID="DropDownList7" runat="server" AutoPostBack="True" CssClass="dropdown-style" OnSelectedIndexChanged="DropDownList7_SelectedIndexChanged">
